...
Original file is located at
    https://colab.research.google.com/drive/1osQ6eX_SPlhX8UnVTVnrOnzeeOztwD_U
"""
...
np.random.seed(7)
#vetor com numeros inteiros aleatorios entre 1, 1500, com 10 amostras.
...
# insere a primeira linha do plot
...
#rotulos
plt.xlabel('Eixo X', color = 'red', size = 12, loc = 'center')
plt.ylabel('Eixo Y')
plt.title('Meu primeiro gráfico', loc = 'left')
...
plt.title('Grafico 1', pad = 10)
plt.xlabel('Eixo X')
plt.ylabel('Eixo Y')

plt.subplot(1, 3, 2)
plt.plot(x, y2, color = 'red')
plt.title('Grafico 2', pad = 10)
plt.xlabel('Eixo X')
plt.ylabel('Eixo Y')

plt.subplot(1, 3, 3)
plt.plot(x, y3, color = 'green')
plt.title('Grafico 3', pad = 10)
plt.xlabel('Eixo X')
plt.ylabel('Eixo Y')
...
fig = plt.figure()
ax = plt.axes()
ax.scatter(x, y, marker = 'o', color = 'blue', label = 'data 1', alpha= 0.5)
...
plt.plot(df.index, df['lifeExp'])
plt.title('Expectativa de vida do Brasil')
plt.ylabel('Expectativa de vida')
plt.xlabel('Tempo');

title = 'Relação entre a expectativa de vida e renda per capita no Brasil'
...
plt.title('População do Brasileira')
...
def filtrar_pais(pais, variavel):
  'Filtrar algum pais da amostra para as variaveis "pop", "gdpPercap", "lifeExp"'
  df = px.data.gapminder()
